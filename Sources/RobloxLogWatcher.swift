...
final class RobloxLogWatcher: ObservableObject {
    ...
    private nonisolated static func readProcessMemory() -> String? {
        ...
        // 🛡️ Sentinel: Validate PID to prevent command injection
    ...
    private func resolveRegion(ip: String) {
        // 🛡️ Sentinel: Validate IP to prevent SSRF and injection
        guard ip.range(of: "^[a-zA-Z0-9.:-]+$", options: .regularExpression) != nil else { return }
    ...
    private nonisolated static func measurePing(ip: String?) -> Int? {
        ...
        // 🛡️ Sentinel: Validate IP to prevent command injection
        guard ip.range(of: "^[a-zA-Z0-9.:-]+$", options: .regularExpression) != nil else { return nil }
